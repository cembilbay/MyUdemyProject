...
namespace WebApıJwt.Models
{
    public class CreateToken
    {
        public string TokenCreate()
        {
            ...
            JwtSecurityToken token = new JwtSecurityToken(issuer: "http://localhost", audience: "http://localhost", notBefore: DateTime.Now, expires: DateTime.Now.AddSeconds(60), signingCredentials: credentials);
